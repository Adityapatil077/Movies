...
<div className="d-flex justify-content-center" style={{ backgroundColor: "#1F222A" }}>
  <div className="d-flex flex-column flex-md-row col-11 mt-2 mb-3 rounded-3">
    
    <div className="col-md-6 bg-black p-2">
      <div className="d-flex">
        ...
        <div className="mt-3 text-light">
          ...
          <div className="mt-1" style={{ color: "lightgray" }}>
            <span className="movie__runtime p-1 border rounded">{currentMovieDetail ? currentMovieDetail.runtime + " mins" : ""}</span>
      ...
      <div className="movie__detailRightBottom text-light mt-3">
